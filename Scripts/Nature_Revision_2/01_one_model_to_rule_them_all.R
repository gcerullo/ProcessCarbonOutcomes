...
# - Write all outputs under Outputs/Nature_Revision_Outputs/Nature_Revision_2/<run_id>/ (no CursorOutputs/CursorModels)
...
# ============================================================
# 0c) NATURE REVISION 2 RUN ROOT (single-folder replicability)
# ============================================================
...
nr_rds_dir <- file.path(step_root, "rds")
...
writeLines(
  c(
    paste0("Latest Nature Revision 2 run"),
...
writeLines(
  c(
    paste0("Latest outputs for 01_one_model_to_rule_them_all.R (Nature Revision 2)"),
    paste0("run_id: ", nr2_run_id),
...
writeLines(
  ...
  con = file.path(step_root, "sessionInfo.txt")
)
